    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ fontSize: 96, fontWeight: 500, lineHeight: 1.02, letterSpacing: "-0.02em" }}>
            {site.name}
          </div>
          <div style={{ marginTop: 28, fontSize: 36, lineHeight: 1.3, fontStyle: "italic", maxWidth: 980 }}>
            {site.tagline}
          </div>
          <div
            style={{
